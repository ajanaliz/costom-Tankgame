 ...
 */
public class BaseHQ extends Ally {
    private BufferedImage hqImage;
    private int health;
    private boolean dead;

    public BaseHQ(float x, float y, ID id, Handler handler, HUD hud) {
    ...
    private void loadImages(){
        try {
            hqImage = ImageIO.read(new File("res/images/Base/factoryGrey.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
